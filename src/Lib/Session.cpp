...
Maybe<UserFlag> Session::get_user_flag(const User const &user) const {
  // TODO
}

void Session::set_authed_user(const User const &user) {
  // TODO
}

void Session::set_user_flag(const User const &user, UserFlag flag) {
  // TODO
}
